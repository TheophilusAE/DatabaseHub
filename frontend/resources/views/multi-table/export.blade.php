...
<div class="container mx-auto px-4 py-8 max-w-7xl">
    <!-- Page Header -->
    <div class="mb-8">
        <h1 class="text-4xl font-bold text-gray-800 mb-2">Multi-Table Export</h1>
        <p class="text-gray-600">Export data from any table or combine multiple tables</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-lg mb-8">
        <div class="border-b border-gray-200">
            <nav class="flex -mb-px">
                <button onclick="switchTab('single')" id="tab-single"
                    class="tab-btn border-b-2 border-blue-500 py-4 px-6 text-center font-semibold text-blue-600">
                    Single Table Export
                </button>
                <button onclick="switchTab('joined')" id="tab-joined"
                    class="tab-btn border-b-2 border-transparent py-4 px-6 text-center font-semibold text-gray-500 hover:text-gray-700 hover:border-gray-300">
        ...
        <!-- Combined Tables Export -->
        <div id="panel-joined" class="p-8 hidden">
            <h2 class="text-2xl font-semibold text-gray-800 mb-6 flex items-center">
