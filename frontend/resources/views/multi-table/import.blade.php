...
<div class="container mx-auto px-3 sm:px-4 py-6 sm:py-8 max-w-7xl">
    ...
    <div class="mb-6 sm:mb-8">
        <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-2">Multi-Table Import</h1>
        <p class="text-sm sm:text-base text-gray-600">Import data to any configured table across multiple databases</p>
    </div>
    ...
    <!-- Import Form -->
    <div class="bg-white rounded-xl shadow-lg p-4 sm:p-8 mb-6 sm:mb-8 border-t-4 border-blue-500">
        ...
        <form id="import-form" class="space-y-6">
            ...
            <div>
                ...
                <div class="mt-1 flex justify-center px-3 sm:px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-blue-500 transition-colors">
    ...
    <!-- Recent Imports -->
    <div class="bg-white rounded-xl shadow-lg p-4 sm:p-6 border-t-4 border-green-500">
        <h2 class="text-xl sm:text-2xl font-semibold text-gray-800 mb-5 sm:mb-6 flex items-center">
                ...
                return `
                    <div class="border-l-4 border-${statusColor}-500 bg-${statusColor}-50 p-4 rounded-r">
                        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                            ...
                            <span class="self-start px-3 py-1 rounded-full text-xs font-medium bg-${statusColor}-100 text-${statusColor}-800">
