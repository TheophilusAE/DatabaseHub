    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
        <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-lg">
            <div class="flex items-center justify-between">
                ...
                <div class="h-12 w-12 bg-white bg-opacity-20 rounded-lg flex items-center justify-center">
                    <img src="{{ asset('Logo/Total_userss.svg') }}" alt="Total Users" class="h-8 w-8 object-contain">
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-green-600 to-green-700 rounded-2xl p-6 text-white shadow-lg">
            <div class="flex items-center justify-between">
                ...
                <div class="h-12 w-12 bg-white bg-opacity-20 rounded-lg flex items-center justify-center">
                    <img src="{{ asset('Logo/admin.svg') }}" alt="Administrators" class="h-8 w-8 object-contain">
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl p-6 text-white shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-green-100 text-sm font-semibold">Users</p>
                    <p class="text-3xl font-bold mt-2">{{ $stats['users'] ?? 0 }}</p>
                </div>
                <div class="h-12 w-12 bg-white bg-opacity-20 rounded-lg flex items-center justify-center">
                    <img src="{{ asset('Logo/User.svg') }}" alt="Regular Users" class="h-8 w-8 object-contain">
                </div>
            </div>
        </div>
    </div>
